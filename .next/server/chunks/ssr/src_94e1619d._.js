...
function ProjectAdmin() {
    ...
    const handleSeedData = async ()=>{
        ...
        // Using individual non-blocking adds
    ...
    const handleDragEnd = ()=>{
        ...
        setSortedItems(newSortedItems);
        // Replace batch write with individual updates
        const updates = [];
        newSortedItems.forEach((item, index)=>{
            if (item.order !== index) {
                ...
                // We are using non-blocking updates, so we don't await here in the loop
...
//# sourceMappingURL=src_94e1619d._.js.map