...
"[project]/src/ai/flows/data:a3947a [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$a3947a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:a3947a [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function ProjectAdmin() {
    ...
    const handleFormSubmit = async (values)=>{
        ...
        try {
            if (values.id) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(docRef, dataToSave, {
                    merge: true
                });
                toast({
                    title: 'Changes Saved',
    ...
    const handleDragEnd = async ()=>{
        ...
        try {
            const updatePromises = newSortedItems.map((item, index)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$a3947a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateProjectOrder"])(item.id, index));
...
function ContactAdmin() {
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(contactDocRef, values, {
                merge: true
            });
            toast({
...
function HomeAdmin() {
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(settingsDocRef, values, {
                merge: true
            });
            toast({
...
//# sourceMappingURL=src_1d6efb75._.js.map