...
function MediaAdmin(props) {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('images');
                    ...
                    "MediaAdmin.useCallback[onDrop]": async ()=>{
                        if (xhr.status === 200) {
                            ...
                            if (firestore) {
                                ...
                                docRefPromise.then({
                                    "MediaAdmin.useCallback[onDrop]": (docRef)=>{
                                        if (docRef) {
                                            ...
                                            setTimeout({
                                                "MediaAdmin.useCallback[onDrop]": ()=>setNewlyUploadedId(null)
                                            }["MediaAdmin.useCallback[onDrop]"], 2000);
                                        }
                                    }
                                }["MediaAdmin.useCallback[onDrop]"]);
                            }
...
_s(MediaAdmin, "D8bjs1BqelqpvdlkXiVJz2HwuFk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirestore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"],
...
_s(AdminPage, "W5QmYCD2ue1xz/inUur9Gj9c4Kc=", false, function() {
    return [
...
//# sourceMappingURL=src_bfcc4ee2._.js.map