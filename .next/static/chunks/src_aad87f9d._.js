...
const useUser = ()=>{
    _s();
    const { user, isUserLoading, userError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])();
    return {
        user,
        isUserLoading,
        userError
...
"[project]/src/firebase/storage/use-storage.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useStorageList(pathRef) {
    ...
    const fetchFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useStorageList.useCallback[fetchFiles]": async ()=>{
            if (!pathRef) {
                setFiles([]);
                setIsLoading(false);
                return;
            ...
            setIsLoading(true);
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listAll"])(pathRef);
                const filePromises = res.items.map({
                    "useStorageList.useCallback[fetchFiles].filePromises": async (itemRef)=>{
                        const url = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDownloadURL"])(itemRef);
                        const metadata = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMetadata"])(itemRef);
                        return {
                            url,
                            name: itemRef.name,
                ...
                }["useStorageList.useCallback[fetchFiles].filePromises"]);
    ...
    }["useStorageList.useCallback[fetchFiles]"], [
        pathRef
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useStorageList.useEffect": ()=>{
            fetchFiles();
        }
    }["useStorageList.useEffect"], [
        fetchFiles
...
_s(useStorageList, "Ptau7lLjoedQWFe+AfQYNRc4AqM=");
...
//# sourceMappingURL=src_aad87f9d._.js.map