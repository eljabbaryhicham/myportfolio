/* [project]/node_modules/xgplayer/dist/index.min.css [app-client] (css) */
...
.xgplayer .xgplayer-controls {
  ...
  opacity: 1;
  z-index: 10;
  background-image: linear-gradient(#0000, #0000005e, #000000bf, #000000bf);
  height: 48px;
...
.xgplayer .xg-right-grid xg-icon, .xgplayer .xg-left-grid > :first-child {
  margin-left: 0;
}
...
.xgplayer.xgplayer-mobile .xgplayer-volume .xgplayer-slider, .xgplayer-replay {
  display: none;
}
...
.xg-mini-layer {
  z-index: 11;
  background: linear-gradient(#393939e6, #39393900 50.27%);
  width: 100%;
  height: 100%;
  display: none;
  position: absolute;
...
.xgplayer xg-trigger[data-xg-action="seeking"] .time-preview, .xgplayer xg-trigger[data-xg-action="playbackrate"] .xg-playbackrate {
  display: block;
}

.xgplayer .gradient {
  pointer-events: none;
  background-image: linear-gradient(#0009, #0000005c 20%, #0000 36% 70%, #0000003d 77%, #0000005c 83%, #0009);
  width: 100%;
  height: 100%;
  display: none;
  position: absolute;
...
.xgplayer .gradient.top {
  background-image: linear-gradient(#0009, #0000005c 20%, #0000 36% 70%);
}

.xgplayer .gradient.bottom {
  background-image: linear-gradient(#0000 70%, #0000003d 77%, #0000005c 83%, #0009);
}
...
.xgplayer-nostart .xgplayer-loading, .xgplayer-pause .xgplayer-loading, .xgplayer-is-enter .xgplayer-loading, .xgplayer-is-ended .xgplayer-loading, .xgplayer-is-error .xgplayer-loading, .xgplayer .xgplayer-pip .xg-exit-pip {
  display: none;
}
...
/*# sourceMappingURL=node_modules_xgplayer_dist_index_min_css_f9ee138c._.single.css.map*/