...
;
;
const VideoPlayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(_c = ()=>__turbopack_context__.r("[project]/src/components/video-player.tsx [app-client] (ecmascript, next/dynamic entry, async loader)")(__turbopack_context__.i), {
    loadableGenerated: {
        modules: [
...
function HomePageContent({ featuredProject, isLoading }) {
    ...
    const contactDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "HomePageContent.useMemoFirebase[contactDocRef]": ()=>firestore ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'contact', 'details') : null
    }["HomePageContent.useMemoFirebase[contactDocRef]"], [
        firestore
    ]);
    const { data: contactInfo, isLoading: isLoadingContact } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$doc$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"])(contactDocRef);
    const videoSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePageContent.useMemo[videoSource]": ()=>{
            const project = featuredProject || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$portfolio$2f$data$2f$portfolio$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultPortfolioItems"].find({
                "HomePageContent.useMemo[videoSource]": (item)=>item.featured && item.type === 'video'
            }["HomePageContent.useMemo[videoSource]"]);
            ...
            if (project.sources && project.sources.length > 0) {
                sourceInfo = {
                    ...
                    sources: project.sources.map({
                        "HomePageContent.useMemo[videoSource]": (s)=>({
                                src: s.src,
                                type: 'video/mp4',
                                size: s.size
                            })
...
_s(HomePageContent, "7QnK7ofD/eGLFm+9Yru7xgxG7U8=", false, function() {
    return [
...
_c2 = HomePageContent;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "VideoPlayer$dynamic");
...
//# sourceMappingURL=src_d3b32f48._.js.map