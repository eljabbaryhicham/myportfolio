...
"[project]/src/features/portfolio/components/HomePageVideo.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$h5player$2f$dist$2f$player$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/h5player/dist/player.js [app-client] (ecmascript)");
...
const HomePageVideo = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$h5player$2f$dist$2f$player$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["H5Player"], {
        ...
        fileName: "[project]/src/features/portfolio/components/HomePageVideo.tsx",
        lineNumber: 19,
        columnNumber: 9
    }, this);
};
_s(HomePageVideo, "k460N28PNzD7zo1YW47Q9UigQis=");
_c = HomePageVideo;
const __TURBOPACK__default__export__ = HomePageVideo;
var _c;
__turbopack_context__.k.register(_c, "HomePageVideo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/node_modules/h5player/dist/player.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ function LyricParser() {
    ...
    LyricParser.prototype = {
        ...
        getLyricAtTime: function(time) {
            ...
            if (line) {
                if (line[0] < time) {
                    while((next = data[++last]) && next[0] <= time)line = next;
                    self.last = last - 1;
                } else {
                    while(line && line[0] > time)line = data[--last];
                    self.last = last;
                }
            }
            return line ? line[1] : '';
 ...
 */ // manage all the players to ensure only one is playing at once
    ...
    Player.prototype = {
        ...
        init: function() {
            ...
            if (_this.options.classes) extend(_this.classes, _this.options.classes);
            container.classList.add('h5p');
            container.innerHTML = '<div class="h5p-image"></div>' + '<div class="h5p-buttons">' + '<i data-id="list" class="h5p-button ' + _this.classes.list + '"></i>' + '</div>' + '<div class="h5p-info">' + '<div class="h5p-title"></div>' + '<div class="h5p-artist"></div>' + '</div>' + '<div class="h5p-control">' + '<i data-id="prev" class="h5p-button ' + _this.classes.prev + '"></i>' + '<i data-id="play" class="h5p-button ' + _this.classes.play + '"></i>' + '<i data-id="next" class="h5p-button ' + _this.classes.next + '"></i>' + '</div>' + '<div class="h5p-progress">' + '<div data-id="bar" class="h5p-wrap">' + '<div class="h5p-bar">' + '<div class="h5p-played"></div>' + '</div>' + '<div class="h5p-cursor"></div>' + '<div class="h5p-time"></div>' + '</div>' + '</div>' + '<div class="h5p-lyric"></div>' + '<div class="h5p-playlist"></div>';
   ...
   */ setSongs: function(songs) {
        ...
        updateInfo: function(song) {
            ...
            if (image) _this.image.innerHTML = '<img src="' + _this.safeHTML(image) + '">';
            // update lyric
            _this.lyric.innerHTML = '';
            if (_this.theme != 'simple' && _song) _this.getLyric(_song);
        },
            ...
            if ('lyric' in song) {
                ...
                if (cb) {
                    ...
                    cb(extend({}, song), function(data) {
                        if (current == _this.current && !song.lyric) _this.lyricParser.setLyric(song.lyric = data);
                    });
                }
            }
        },
    ...
    !function(root, factory) {
        if (("TURBOPACK compile-time value", "object") === 'object' && module.exports) module.exports = factory();
        else root.h5player = factory();
...
//# sourceMappingURL=_d718dcd7._.js.map