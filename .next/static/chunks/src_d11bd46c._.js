...
"[project]/src/features/admin/actions/data:048d0e [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$admin$2f$actions$2f$data$3a$048d0e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/features/admin/actions/data:048d0e [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function MediaAdmin() {
    ...
    const handleDelete = async (docId)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$admin$2f$actions$2f$data$3a$048d0e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteMediaAsset"])(docId);
            if (result.success) {
                toast({
                    title: "File Removed",
...
//# sourceMappingURL=src_d11bd46c._.js.map