    ...
    <div className="h-full w-full flex flex-col">
      ...
      <div ref={scrollRef} className="flex-1 min-h-0 overflow-y-auto">
        <div className="p-[clamp(1rem,3vh,2rem)] md:p-[clamp(1.5rem,4vh,2rem)] w-full flex items-center justify-center min-h-full">
            ...
            <>
            <motion.div
                  className="w-full flex flex-col gap-[clamp(1rem,3vh,2rem)] items-center justify-center landscape:flex-row landscape:items-stretch"
                  variants={containerVariants}
                  initial="hidden"
                  animate="visible"
                >
                  <motion.div className="w-full landscape:w-1/2 landscape:h-full flex justify-center" variants={itemVariants}>
                            ...
                            <div className="flex justify-center w-full">
                                <Button asChild className="bg-gradient-to-r from-green-500 to-emerald-600 animate-shake" size="lg">
                                    <Link href={`https://wa.me/${contactInfo.whatsApp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm font-semibold leading-tight">{t('contact.whatsApp')}</span>
                                    </Link>
                                </Button>
                            </div>
                          </>
