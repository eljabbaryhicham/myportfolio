...
export function AppNav() {
  ...
  return (
    <aside className="w-full md:w-28 flex-shrink-0 p-0 md:p-4 mt-4 md:mt-0">
      <div className={cn("flex h-auto md:h-full flex-row md:flex-col items-center justify-between rounded-lg border border-border/50 py-[2%] px-8 md:p-8 glass-effect")}>
