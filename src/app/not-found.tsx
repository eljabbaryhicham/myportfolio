...
export default function NotFound() {
  return (
    <>
      {/*
        Client component: no `metadata` export allowed. Inject noindex directly
        so 404 pages don't waste crawl budget or trigger soft-404 penalties.
      */}
      <head>
        <title>Page Not Found | MelliVision</title>
