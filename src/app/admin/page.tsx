          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
            <div className="w-full flex justify-center">
              <TabsList className="flex-wrap h-auto justify-center">
                  ...
                  <TabsTrigger value="media" className="glass-effect bg-blue-900/50 text-white data-[state=active]:bg-destructive data-[state=active]:animate-glow">Media</TabsTrigger>
                  {isSuperAdmin && <TabsTrigger value="admins" className="glass-effect bg-blue-900/50 text-white data-[state=active]:bg-destructive data-[state=active]:animate-glow">Admins</TabsTrigger>}
              </TabsList>
            </div>
