...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME_3: process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME_3,
    NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET_3: process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET_3,
  }
};
